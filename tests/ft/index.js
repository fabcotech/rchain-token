...
const { PRIVATE_KEY, PUBLIC_KEY, PRIVATE_KEY_2, PUBLIC_KEY_2, PRIVATE_KEY_3, PUBLIC_KEY_3 } = require('./keys');
...
const main = async () => {
  ...
  console.log('tests:ft total time : ' + Math.round((new Date().getTime() - time) / 600) / 100 + 'min')
};
